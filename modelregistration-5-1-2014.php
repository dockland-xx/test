...
<tbody>
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF12" class="style10">  
      <option value="-None-">
  ...
  <tr>
    <td  class="style5">
      First Name &nbsp;&nbsp;:</font>    </td>
    <td width="75%" >
      <input name="First Name" type="text" class="style10" size="40" maxlength="40">    </td>
  </tr>

    <tr>
      <td  class="style5">Last Name &nbsp;&nbsp;:</font></td>
      <td width="75%" >
      <input name="Last Name" type="text" class="style10" size="40" maxlength="80"> </td></tr><tr>
      <td  class="style5">Email &nbsp;&nbsp;:</font></td>
      <td width="75%" >
      <input name="Email" type="text" class="style10" size="40" maxlength="100"> </td></tr>
  <tr>
  ...
  <tr><td  class="style5">Home Phone &nbsp;&nbsp;:</font></td>
    <td width="75%" >
    <input name="Home Phone" type="text" class="style10" size="27" maxlength="30"> </td></tr><tr>
      <td  class="style5">Mobile &nbsp;&nbsp;:</font></td>
      <td width="75%" >
      <input name="Mobile" type="text" class="style10" size="27" maxlength="30"> </td></tr>
  <tr>
  ...
  <tr><td  class="style5">Date of Birth &nbsp;&nbsp;:</font></td>
    <td width="75%" >
    <input name="Date of Birth" type="text" class="style10" size="24" maxlength="20">
    <font color="#FFFFFF" face="Arial">&nbsp;&nbsp; dd/mm/yyyy    </font> </td>
  </tr>
  <tr>
    <td  class="style5">Ethnicity &nbsp;&nbsp;:</font></td>
    <td width="75%" ><select name="CONTACTCF8" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF9" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF10" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF26" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><input name="CONTACTCF27" type="text" class="style10" maxlength="20"> </td>
  </tr>
  <tr>
    <td  class="style5">Hair Colour &nbsp;&nbsp;:</font></td>
    <td width="75%" ><select name="CONTACTCF5" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF6" class="style10">  
      <option value="-None-">
  ...
  <tr><td  class="style5">Height &nbsp;&nbsp;:</font></td>
    <td width="75%" ><select name="CONTACTCF2" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF4" class="style10">  
      <option value="-None-">
  ...
  <tr><td  class="style5">Waist &nbsp;&nbsp;:</font></td>
    <td width="75%" ><select name="CONTACTCF3" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF11" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF31" class="style10">  
      <option value="-None-">
  ...
  <tr>
    ...
    <td width="75%" ><select name="CONTACTCF32" class="style10">  
      <option value="-None-">
  ...
  <tr><td  class="style5">Dress Size &nbsp;&nbsp;:</font></td>
    <td width="75%" ><select name="CONTACTCF7" class="style10">  
      <option value="-None-">
    ...
    16-18</option>  <option value="18+">18+</option>  </select></td></tr><tr>
      ...
      <td width="75%" ><select name="CONTACTCF13" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Yes">Yes</option>  </select></td></tr><tr>
      ...
      <td width="75%" ><select name="CONTACTCF14" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Yes">Yes</option>  </select></td></tr><tr>
      <td  class="style5">I am interested in Hostess Jobs &nbsp;&nbsp;:</font></td>
      <td width="75%" ><select name="CONTACTCF15" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Yes">Yes</option>  </select></td></tr><tr>
      <td  class="style5">I am a Dancer &nbsp;&nbsp;:</font></td>
      <td width="75%" ><select name="CONTACTCF16" class="style10">  
        <option value="-None-">
  ...
  <tr><td  class="style5">I am interested in Hand Modelling &nbsp;&nbsp;:</font></td>
    ...
    Basic</option>  <option value="Professionals">Professionals</option>  </select></td></tr><tr>
      ...
      <td width="75%" ><select name="CONTACTCF20" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Basic">
    Basic</option>  <option value="Professional">Professional</option>  </select></td></tr><tr>
      <td  class="style5">I am a Singer &nbsp;&nbsp;:</font></td>
      <td width="75%" ><select name="CONTACTCF21" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Basic">
    Basic</option>  <option value="Professional">Professional</option>  </select></td></tr><tr>
      <td  class="style5">I am a Musician &nbsp;&nbsp;:</font></td>
      <td width="75%" ><select name="CONTACTCF22" class="style10">  
        <option value="-None-">
    -None-</option>  <option value="No">No</option>  <option value="Basic">
    Basic</option>  <option value="Professional">Professional</option>  </select></td></tr><tr>
      <td  class="style5">Which Instrument do you Play &nbsp;&nbsp;:</font></td>
      <td width="75%" >
      <input name="CONTACTCF23" type="text" class="style10" size="68" maxlength="50"> </td></tr><tr>
      <td  class="style5">Spoken Languages &nbsp;&nbsp;:</font></td>
      <td width="75%" >
    <input name="CONTACTCF28" type="text" class="style10" size="67" maxlength="255"> </td></tr><tr>
      <td  class="style5">Open
    Comments &nbsp;&nbsp;:</font></td><td width="75%" >
    <input name="CONTACTCF29" type="text" class="style10" size="67" maxlength="255"> </td></tr>
 ...
 <tr>
    ...
    <td>
      <label>
          <input name="file1[]" type="file" class="style10" accept="image/gif, image/jpeg, image/png, image/jpg" multiple="true" />
      </label>    </td>
  </tr>
